            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <%--<dd data-name="template-page">--%>
                                <%--<a lay-href="${domain}/template/go_template_list">模板页面</a>--%>
                            <%--</dd>--%>
                            <dd data-name="topic-page">
                                <a lay-href="${domain}/activity/go_activity_list">活动管理</a>
                            </dd>
                            <dd data-name="topic-page">
                                <a lay-href="${domain}/topic/go_topic_list">灯谜管理</a>
                            </dd>
                            <dd data-name="participant-page">
                                <a lay-href="${domain}/participant/go_participant_list">活动参与人员</a>
                            </dd>
                        </dl>
                    </li>
<%--                    <li data-name="component" class="layui-nav-item">
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="home/console.html" lay-attr="home/console.html" class=""><i
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="${domain}/home/console" frameborder="0"
...
<script>
    layui.config({
        base: '${domain}/layuiadmin/' //静态资源所在路径
    }).extend({
